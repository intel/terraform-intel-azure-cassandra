...
Standard_D16s_v5, Standard_D32s_v5, Standard_D8s_v5, Standard_E8s_v5, Standard_E16s_v5, Standard_E20s_V5, Standard_E32s_v5

Dsv5-series sizes run on the 4th Generation Intel® Xeon® Platinum 8473C (Sapphire Rapids) or the Intel® Xeon® Platinum 8272CL (Cascade Lake). The Dv5-series sizes offer a combination of vCPU, memory and remote storage options for most production workloads. Dsv5-series VMs feature Intel® Hyper-Threading Technology. Remote Data disk storage is billed separately from virtual machines.

DSv5-series sizes run on the 4th Generation Intel® Xeon® Platinum 8473C (Sapphire Rapids), Intel® Xeon® Platinum 8272CL (Cascade Lake), Intel® Xeon® 8171M 2.1GHz (Skylake) or the the Intel® Xeon® E5-2673 v4 2.3 GHz (Broadwell), or the Intel® Xeon® E5-2673 v3 2.4 GHz (Haswell) processors with Intel Turbo Boost Technology 2.0 and use premium storage.

Esv5-series sizes run on the 4th Generation Intel® Xeon® Platinum 8473C (Sapphire Rapids) or the Intel® Xeon® Platinum 8272CL (Cascade Lake). The Esv5-series instances are ideal for memory-intensive enterprise applications. Evs5-series VMs feature Intel® Hyper-Threading Technology. Remote Data disk storage is billed separately from virtual machines.
